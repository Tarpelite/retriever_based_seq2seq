...
def main():
    ...
    for model_recover_path in [args.model_path.strip()]:
        ...
        doc_dataset = utils.RetrievalSeq2seqDocDatasetForBert(
            features=doc_features, max_source_len = args.max_seq_length - args.max_tgt_length-2, max_target_len=args.max_tgt_seq_length, vocab_size=tokenizer.vocab_size, cls_id=tokenizer.cls_token_id, sep_id=tokenizer.sep_token_id, pad_id=tokenizer.pad_token_id,
