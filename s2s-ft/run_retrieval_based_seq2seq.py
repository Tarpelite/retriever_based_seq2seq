...
def get_args():
    ...
    parser.add_argument("--train_doc_file", default=None, type=str, required=True)
    ...
    parser.add_argument("--cached_train_doc_features_file", default=None, type=str)
...
def get_model_and_tokenizer(args):
    ...
    retrieval = BertForRetrieval.from_pretrained(
...
def main():
    ...
    if args.cached_train_doc_features_file is None:
        args.cached_train_doc_features_file = os.path.join(args.output_dir, "cached_doc_features_for_training.pt")
